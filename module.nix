...
let
  ...
  bashScripts = {
    # Gets the initial, autogenerated admin password if it exists, or the empty string if it doesn't
    getInitialAdminPassword = ''cat "${cfg.home}/nexus3/admin.password" || echo ""'';
  };
in
